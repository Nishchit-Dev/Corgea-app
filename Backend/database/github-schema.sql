...
CREATE TABLE IF NOT EXISTS scan_jobs (
    ...
    scan_type VARCHAR(20) DEFAULT 'full', -- full, incremental, file
...
CREATE TABLE IF NOT EXISTS vulnerability_details (
    ...
    category VARCHAR(50) NOT NULL, -- sql_injection, xss, auth_bypass, etc.
    line_number INTEGER,
    column_number INTEGER,
    code_snippet TEXT,
    cwe_id VARCHAR(10), -- Common Weakness Enumeration ID
    owasp_category VARCHAR(50), -- OWASP Top 10 category
...
CREATE TABLE IF NOT EXISTS user_preferences (
    ...
    scan_schedule VARCHAR(20), -- daily, weekly, monthly, manual
